    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mf_hash', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('company_description', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('forgot_pwd_email_code', models.CharField(blank=True, max_length=20, null=True)),
                ...
                ('status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='user_profile.userstatus')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.Permission', verbose_name='user permissions')),
                ('user_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='user_profile.usertype')),
            ],
            options={
                'verbose_name': 'user',
